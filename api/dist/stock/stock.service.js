...
let StockService = class StockService {
    ...
    async updateStock(id, quantity, token) {
        ...
        if (!stock) {
            throw new common_1.UnauthorizedException('Stock not found');
        }
        if (stock.userId !== decodedToken.id) {
            console.log(decodedToken.id);
            throw new common_1.UnauthorizedException('You do not have permission to update this stock');
        }
